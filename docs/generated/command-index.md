...
| `collect` | `src/commands/collect.ts` | `<unit>` | `--checkpoint <value>`<br>`--fixture <file>`<br>`--output <file>`<br>`--profile <name>`<br>`--headed` | Execute one versioned, bounded CollectionUnit |
