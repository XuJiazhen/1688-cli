...
|---|---|---|---|---|
| `login` | `src/commands/login.ts` | - | `--force`<br>`--timeout <seconds>`<br>`--profile <name>`<br>`--headed` | Log in to 1688 by scanning a QR code |
...
| `serve` | - | - | `--profile <name>`<br>`--supervisor-config <path>` | Run a Supervisor-managed 1688 daemon in the foreground |
| `daemon` | - | - | - | - |
